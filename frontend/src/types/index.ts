...
export const STATUS_LABELS: Record<string, string> = {
  ...
  building_contract: '构建研究契约',
  decomposing: '分解研究问题',
  searching: '检索中',
  extracting_evidence: '抽取证据',
  updating_coverage: '更新覆盖矩阵',
  building_wiki: '构建 Wiki',
  building_clusters: '聚类分析',
  summarizing: '摘要中',
...
export const STATUS_COLORS: Record<string, string> = {
  ...
  building_contract: 'bg-blue-100 text-blue-700',
  decomposing: 'bg-blue-100 text-blue-700',
  searching: 'bg-indigo-100 text-indigo-700',
  extracting_evidence: 'bg-indigo-100 text-indigo-700',
  updating_coverage: 'bg-indigo-100 text-indigo-700',
  building_wiki: 'bg-indigo-100 text-indigo-700',
  building_clusters: 'bg-indigo-100 text-indigo-700',
